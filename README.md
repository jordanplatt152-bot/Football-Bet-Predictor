...
- Candidates require an ACTIVE model, PASS data, A/B/C model and price grades, at least £50 available liquidity, a price no more than ten minutes old and both capture/current time strictly before the pre-match cutoff.
